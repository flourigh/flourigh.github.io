...
if (getWindowLocation() === 'stackoverflow') {
    location.assign('https://pt.stackoverflow.com/users/8939'); };

if (getWindowLocation() === 'snapchat') {
